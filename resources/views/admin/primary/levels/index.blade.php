...
<section class="page-content">
   <div class="mx-auto w-60">
      <div class="frow align-items-center stretched my-5">
         <div class='txt-l mr-3'>Study Levels </div>
      ...
      <div class="frow px-2 my-2 tr">
         ...
         <div class="fcol mid-right w-15">
            <div class="frow stretched">
               <a href="{{route('levels.edit',$level)}}"><i data-feather='edit-2' class="feather-xsmall mx-1 txt-blue"></i></a>
               <div>
...
<div class="slider" id='addslider'>
   ...
   <div class="frow centered my-4 txt-b">New Level</div>
