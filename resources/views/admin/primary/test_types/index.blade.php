...
<div class="fcol h-30 w-100 bg-banner top-mid sticky-top">
   ...
   <div class='txt-l txt-white'>Test Types</div>
   <div class='frow txt-s txt-white'><a href="{{url('primary')}}">Primary </a> <span class="mx-1"> / </span>Test types </div>
</div>
@endsection
...
<div class="slider" id='editslider'>
   ...
   <!-- data form -->
   <form action="{{route('test_types_update')}}" method='post'>
      @csrf
      <div class="frow stretched my-4 auto-col">
         <div class="fancyinput w-100">
