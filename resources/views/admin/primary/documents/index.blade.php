...
<div class="fcol h-30 w-100 bg-banner top-mid sticky-top">
   ...
   <div class='frow txt-s txt-white'><a href="{{url('primary')}}">Primary </a> <span class="mx-1"> / </span>documents </div>
</div>
@endsection
   ...
   <div class="frow px-2 my-2 tr">
      ...
      <div class="fcol mid-right w-15">
         <div class="frow stretched">
            <div onclick="toggle_editslider('{{$document->id}}','{{$document->name}}')"><i data-feather='edit-2' class="feather-xsmall mx-1 txt-blue"></i></div>
            <div>
...
<div class="slider" id='editslider'>
   ...
   <!-- data form -->
   <form action="{{route('documents_update')}}" method='post'>
      @csrf
      <div class="frow stretched my-4 auto-col">
         <div class="fancyinput w-100">
