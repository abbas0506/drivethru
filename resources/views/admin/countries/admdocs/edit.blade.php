...
<section class="page-content">
   <div class='w-70 mx-auto txt-l my-5 '>Countries <span class="txt-s ml-2"> - {{$country->name}} - admission docs - add </span> </div>
   <div class="frow w-70 mx-auto stretched mt-2">
      ...
      <div class="w-70 py-4 px-5 bg-white border relative">
         <a href="{{route('admdocs.index', $country)}}">
         ...
         <form action="{{route('admdocs.store')}}" class='mt-3' method='post' id='form'>
            @csrf
