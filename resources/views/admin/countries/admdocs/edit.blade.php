...
<div class="frow w-100 bg-custom-light p-4 rw-100 auto-col stretched">
   <div class="fcol w-72 rw-100 py-4 px-5 bg-white ">
      <div class="frow w-100 rw-100 stretched">
         <div class="txt-b txt-m">Make Admission Requirements List </div>
      </div>
      ...
      <div class="fcol w-100 rw-100 centered">
         ...
         <form action="{{route('admdocs.store')}}" class='w-80 mt-3' method='post' id='form'>
            @csrf
            ...
            <div class="frow mid-right mt-4">
               <div class="btn-rounded-custom-orange px-3" onclick="postAdmDoc()">Add Now</div>
            </div>
         </form>
         @else
         <div class="fcol">
            ...
            <div class="txt-grey text-center mt-3">
               Either all documents have been added as admission requirement for current country, or documnents list is empty.
               Any how, no further document is available for admission requirement. Click on Admission Requirements option on side panel to see current list of admission requirements.
            </div>
         </div>
