<nav class="horizontal-navbar px-4">
   ...
   <div class="nav-links">
      <ul>
         <li><span class="lnr lnr-cog mr-2"></span>Representative Panel</li>
         <li class="mx-4">|</li>
         <li><a href="{{url('representative')}}"><span class="lnr lnr-home"></span></a></li>
         <li><a href="{{url('r/changepw')}}"><span class="lnr lnr-user"></span></a></li>
