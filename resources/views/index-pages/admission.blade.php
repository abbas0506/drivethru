...
<section class="section-80">
   ...
   <div class="row">
      ...
      <div class="col">
         <img src="{{asset('/images/admission/1.jpg')}}" alt="" width="350">
      </div>
   </div>
</section>
   ...
   <div class="row">
      <div class="col w-45 block">
         <div class="content">
            ...
            <img src="{{asset('/images/admission/2.jpg')}}" alt="" width="300" hight="150">
      ...
      <div class="col w-45 block">
         <div class="content">
            ...
            <div class="txt-blue txt-20 txt-b">ADMISSION</div>
            <img src="{{asset('/images/admission/3.jpg')}}" alt="" width="300" hight="150">
