...
<section class='page-content'>
   ...
   <div class='w-60 mx-auto txt-l my-5 '> <span class="lnr lnr-graduation-hat mr-3"></span>Last Merit - <span class="txt-s">{{$university->name}}</span></div>
   <div class="w-60 mx-auto">
      ...
      <div class="my-2">
         ...
         <div class="frow p-1 mt-2 border-bottom tr txt-s txt-grey">
            ...
            <div class="w-20 text-right">Last Merit </div>
         ...
         <div class="frow p-1 border-bottom tr">
            ...
            <div class="w-20 text-right txt-s">{{$unicourse->lastmerit}}</div>
            <div class="w-10 text-center txt-s">
               <a href="{{route('lastmerit.edit', $unicourse->id)}}" class="text-primary"> <i data-feather='edit-3' class="feather-xsmall"></i></a>
            </div>
         </div>
         @endforeach
         @else
