...
<div class="fcol h-30 w-100 bg-banner top-mid sticky-top">
   ...
   <div class='frow txt-s txt-white'>
      ...
      <a href="{{url('newsfeed')}}">News Feed </a> <span class="mx-1"> / </span>
      cities
   </div>
</div>
@endsection
...
<div class="container-60">
   ...
   <div class="frow px-2 py-1 mb-2 txt-b bg-info">
      ...
      <div class="fcol mid-left w-75">News Text </div>
   ...
   <div class="frow px-2 my-2 tr">
      <div class="fcol mid-left w-10">{{$sr++}} </div>
      <div class="fcol mid-left w-75"> {{$newsitem->text}} </div>
      <div class="fcol mid-right w-15">
         <div class="frow stretched">
            ...
            <div>
               <form action="{{route('news.destroy',$newsitem)}}" method="POST" id='del_form{{$sr}}'>
                  @csrf
                  @method('DELETE')
