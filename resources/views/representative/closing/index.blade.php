...
<section class='page-content'>
   ...
   <div class='w-60 mx-auto txt-l my-5 '> <span class="lnr lnr-calendar-full mr-3"></span> Closing Date</div>
   <div class="w-60 mx-auto">
      <div class="bg-custom-light p-2 mb-3 relative">
         ...
         <ul>
            ...
            <li>Click on university name to set closing date of its various courses</li>
         </ul>
      </div>
