...
class FindUniversityController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('user.national.finduniversities.index.index', compact('cities', 'faculties'));
    }
    ...
    public function fetchUniversities(Request $request)
    {
        if (isset($request->manual)) {
            ...
            return view('user.national.finduniversities.index.listofuniversities', compact('universities'));
        } else {
            // auto search request
            $request->validate([
                'course_id1' => 'required',
            ...
            try {
                ...
                return view('user.national.finduniversities.index.listofuniversities', compact('data', 'courses'));
            } catch (Exception $e) {
    ...
    public function download()
    {
        ...
        $pdf = PDF::loadView("user.national.finduniversities.index.download", compact('courses', 'data'));
        $pdf->output();
