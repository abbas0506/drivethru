...
class UniversitySeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        University::create(['name' => 'LUMS, Lahore', 'city_id' => 2, 'type' => 'public', 'rank' => 3, 'step1' => 1]);
        University::create(['name' => 'Punjab University, Lahore', 'city_id' => 2, 'type' => 'private', 'rank' => 4, 'step1' => 1]);
